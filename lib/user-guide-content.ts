...
export const USER_GUIDE_HELP = [
  {
    question: "‘근거를 찾지 못했다’거나 ‘확인되지 않는다’고 나와요.",
  ...
  {
    question: "어떤 것부터 공부할지도 물어봐도 되나요?",
    answer: "네. 준비하는 평가나 교육 주제를 말하고 ‘무엇부터 공부할까?’라고 물어보세요. 튜터는 자료에서 확인한 내용과 AI가 제안하는 공부 순서를 나누어 설명합니다. 공부 순서는 공식 평가 순서나 현장 행동 지시가 아닙니다. 같은 주제는 이어서 질문해도 됩니다.",
  },
  {
